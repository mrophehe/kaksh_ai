                ...
                {isGenerationFailed ? (
                  ...
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="relative w-12 h-12">
                      ...
                      <div className="absolute inset-0 rounded-full border-2 border-transparent border-t-amber-500 dark:border-t-amber-400 animate-spin" />
                    </div>
                    {/* Text */}
                    <motion.span
            ...
            {showPlayHint && (
              ...
              >
                ...
                >
                  ...
                  >
                    <Play className="w-7 h-7 text-amber-600 dark:text-amber-400 fill-amber-600/90 dark:fill-amber-400/90 ml-0.5" />
                  </motion.div>
                </motion.div>
              </motion.div>
            )}
