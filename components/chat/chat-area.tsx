      ...
      >
        ...
        {!collapsed && (
          <div
            ...
            className="absolute left-0 top-0 bottom-0 w-1.5 cursor-col-resize z-50 group hover:bg-amber-400/30 dark:hover:bg-amber-600/30 active:bg-amber-500/40 dark:active:bg-amber-500/40 transition-colors"
          >
            <div className="absolute left-0.5 top-1/2 -translate-y-1/2 w-0.5 h-8 rounded-full bg-gray-300 dark:bg-gray-600 group-hover:bg-amber-400 dark:group-hover:bg-amber-500 transition-colors" />
          </div>
        )}
