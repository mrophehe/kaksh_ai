...
const WB_STYLE =
  'bg-amber-500 dark:bg-amber-500/15 border-amber-500/40 dark:border-amber-500/30 text-amber-500 dark:text-amber-500';
const WB_ACCENT = 'bg-amber-500 dark:bg-amber-500';
  ...
  return (
    ...
    >
      ...
      {isWb && (
        ...
        >
          <PenLine className="w-1.75 h-1.75 text-white dark:text-amber-500" strokeWidth={2.5} />
        </span>
      )}
