  ...
  return (
    <div
      className={cn(
        ...
        isUser
          ? 'bg-linear-to-br from-amber-600 to-amber-700 dark:from-amber-500 dark:to-amber-600 text-white rounded-tr-sm shadow-sm shadow-amber-300/30 dark:shadow-amber-900/50 ring-1 ring-amber-500/20'
          : isTeacher
          ...
          return (
            <motion.div
              ...
              className={cn(
                ...
                isActiveBubble &&
                  'border-l-amber-500 dark:border-l-amber-500 bg-amber-500/50 dark:bg-amber-500/20',
              )}
            >
              {/* Mini Avatar */}
