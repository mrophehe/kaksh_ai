    ...
    >
      ...
      >
        {showDisabled ? (
          ...
          <div className="w-full h-full bg-linear-to-br from-indigo-50 via-amber-500/60 to-blue-50 dark:from-indigo-950/40 dark:via-amber-500/30 dark:to-blue-950/20 flex items-center justify-center rounded">
            <style>{`
