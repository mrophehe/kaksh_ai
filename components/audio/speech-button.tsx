      ...
      <TooltipTrigger asChild>
        <button
          ...
          className={cn(
            ...
            sizeClasses,
            active
              ? 'bg-amber-500/90 text-black shadow-[0_0_12px_rgba(245,158,11,0.45)]'
        ...
        >
          ...
          {isRecording && (
            <span
              className="absolute -inset-1 rounded-[10px] border border-amber-400/40 dark:border-amber-400/30"
              style={{
