...
export const ENTER_ANIMATIONS = [
  ...
  },
  {
    ...
    name: 'Light Speed In',
    children: [
      { name: 'Speed In Right', value: 'lightSpeedInRight' },
      { name: 'Speed In Left', value: 'lightSpeedInLeft' },
    ],
  },
];
...
export const EXIT_ANIMATIONS = [
  ...
  },
  {
    ...
    children: [
      { name: 'Speed Out Right', value: 'lightSpeedOutRight' },
      { name: 'Speed Out Left', value: 'lightSpeedOutLeft' },
    ],
  },
];
...
export const SLIDE_ANIMATIONS: SlideAnimation[] = [
  ...
  { label: 'Scale Down', value: 'scaleReverse' },
];
