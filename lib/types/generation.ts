...
export interface UserRequirements {
  ...
  language: 'en-US' | 'hi-IN'; // Course language - critical for generation
...
export interface SceneOutline {
  ...
  order: number;
  language?: 'en-US' | 'hi-IN'; // Generation language (inherited from requirements)
